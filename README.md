...
// spark 2.0.x
libraryDependencies += "io.hydrosphere" %% "spark-2_0-ml-serving" % "0.1.1"
// spark 2.1.x
libraryDependencies += "io.hydrosphere" %% "spark-2_1-ml-serving" % "0.1.1"
// spark 2.2.x
libraryDependencies += "io.hydrosphere" %% "spark-2_2-ml-serving" % "0.1.1"
```
